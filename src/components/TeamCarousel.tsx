    ...
    <div ref={carouselRef} className="relative w-full max-w-6xl mx-auto px-4">
      ...
      <div className="block lg:hidden">
        ...
        <div className="w-full max-w-sm mx-auto">
          <div 
            className="bg-white rounded-3xl shadow-2xl transition-all duration-1000 transform relative overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="relative p-6 pt-8 text-center">
              ...
              <div className="mb-6">
                <div 
                  className="w-24 h-24 mx-auto rounded-full flex items-center justify-center shadow-2xl overflow-hidden border-4 border-green-700 bg-white"
                  style={{
              ...
              {/* Role */}
              <div 
                className="inline-flex items-center text-xs font-bold px-4 py-2 rounded-lg mb-4 relative overflow-hidden"
                style={{
                  background: 'linear-gradient(135deg, #22643c 0%, #34a853 50%, #1a4d2e 100%)',
                  color: 'white',
                  boxShadow: '0 6px 20px rgba(34, 100, 60, 0.3)'
                }}
              >
              ...
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 text-white font-bold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-sm"
                style={{
                  background: 'linear-gradient(135deg, #22643c 0%, #34a853 50%, #1a4d2e 100%)',
        ...
        <div className="flex items-center justify-center mt-8 gap-6">
          ...
          <button
            onClick={prevMember}
            className="group flex items-center justify-center w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 border border-green-100"
          >
            <svg 
              width="20" 
              height="20" 
